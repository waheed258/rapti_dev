...
public partial class Admin_Branch : System.Web.UI.Page
{
    ...
    BABranch _objBALBranch = new BABranch();
   
    public string FileLogo = string.Empty;
    EmMainAccount objEMMainAccount = new EmMainAccount();
    BALMainAccount objBALMainAcc = new BALMainAccount();
    ...
    private void BindVatType()
    {
        ...
        {
            int vatid = 0;
            DataSet ds = _objBoutility.GetVatData(vatid);
